...
1. Griffith's & Harris goes about defining the curvature matrix of a connection $D$ on a complex vector bundle $E\to M$ as follows. For sections $\psi\in\mathcal{A}^p(U)$ and $\xi\in\mathcal{A}^0(E)(U)$, we enforce the Leibniz rule
